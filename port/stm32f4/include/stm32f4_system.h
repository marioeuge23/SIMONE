    ...
    /**
    *@brief Lee el valor de un pin del GPIO
    *
    *@param p_port Puerto del GPIO
    *@param pin Pin/línea del GPIO (índice de 0 a 15)
    *@return El valor del pin leído (0 o 1)
    */
    bool stm32f4_system_gpio_read(GPIO_TypeDef *p_port, uint8_t pin);

    /**
     * @brief Escribe un valor en un pin del GPIO
     * 
     * @param p_port Puerto del GPIO
     * @param pin Pin/línea del GPIO (índice de 0 a 15)
     * @param value Valor a escribir (true para nivel alto, false para nivel bajo)
     * @return None
     */
    void stm32f4_system_gpio_write(GPIO_TypeDef *p_port, uint8_t pin, bool value);

    /**
     * @brief Cambia el valor de un pin del GPIO
     * 
     * @param p_port Puerto del GPIO
     * @param pin Pin/línea del GPIO (índice de 0 a 15)
     * @return None
